  ...
  <div class="w3-row w3-dark-gray">
    ...
    <div class="w3-col l2" style="padding-top: 2%;background-color: transparent;">
      <div class="w3-dropdown-hover" style="background-color: transparent;">
        <button class="w3-button w3-round w3-light-blue w3-large">Approval<span class="w3-badge w3-red"><?php echo"$nt";?></span></button>
    ...
    <div class="w3-col l2" style="padding-top: 2%;">
      <a href="admin-transactionlist.php" class="w3-button w3-round w3-light-blue w3-large">transactions<span class="w3-badge w3-red"><?php echo"$n4";?></span></a>
    </div>
    <div class="w3-col l2" style="padding-top: 2%;background-color: transparent;">
      <div class="w3-dropdown-hover" style="background-color: transparent;">
        <button class="w3-button w3-round w3-light-blue w3-large">Users<span class="w3-badge w3-red"><?php echo"$nt1";?></span></button>
        <div class="w3-dropdown-content w3-bar-block w3-card-4">
    ...
    <div class="w3-col l2"  style="padding-top: 2%;">
      <div class="w3-dropdown-hover" style="background-color: transparent;">
        ...
        <a href="admin.php?status=logout" class="w3-button w3-round w3-light-blue w3-large">Logout</a>
      </div>
    </div>
